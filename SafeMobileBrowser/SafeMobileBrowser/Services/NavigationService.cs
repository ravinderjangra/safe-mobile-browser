...
namespace SafeMobileBrowser.Services
{
    public class NavigationService : INavigationService
    {
        ...
        /// <inheritdoc />
        public void SwitchDetailPage<T>(Action<T> initialize = null)
        ...
        /// <inheritdoc />
        public void RegisterViewModels(System.Reflection.Assembly assembly)
        {
        ...
        public async Task PopPopupAsync(bool animate)
        {
            await FormsNavigation.PopPopupAsync(animate);
        }
        ...
        {
            await FormsNavigation.PushPopupAsync(popupPage);
        }
        ...
        /// <inheritdoc />
        public async Task PushModalAsync<T>(Action<T> initialize = null)
            where T : BaseNavigationViewModel
        {
            T viewModel;
